  ...
  return (
    <Stack className="footer-bg">
      <div className="content-container">
        <Container fluid>
          <Row>
            <Col xl={6} lg={5} md={12} sm={12} xs={12} data-aos="fade-zoom-in" data-aos-duration="1000">
            ...
            <Col xl={6} lg={7} md={12} sm={12} xs={12} data-aos="fade-zoom-in" data-aos-duration="1000">
