...
import ThinkingLady from "../../assets/svgs/pod-thinking-lady.svg"
        ...
        <div className='pod-container'>
            <Container>
                <div className="row d-flex justify-content-md-center screen-container">
                    <div className='col-xs-12 col-sm-12 col-md-6 col-lg-5 pod-left-container'>
                    ...
                    <div className='col-xs-12 col-sm-12 col-md-6 col-lg-4 d-flex justify-content-md-center pod-right-container'>
